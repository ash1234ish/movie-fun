...
public class HomeController {
    ...
    public HomeController(MoviesBean moviesBean, AlbumsBean albumsBean, MovieFixtures movieFixtures, AlbumFixtures albumFixtures,
                          /*@Qualifier("movieTransactionManager")*/ PlatformTransactionManager movieTransactionManager,
                          /*@Qualifier("albumTransactionManager")*/ PlatformTransactionManager albumTransactionManager) {
